...
export class SimpleFileProcessor {
    ...
    inferSchemaFromText(content) {
        ...
        const tables = foundEntities.map(entity => {
            ...
            if (entity === 'customer' || entity === 'user') {
                columns.push({ name: 'email', type: 'TEXT', nullable: true }, { name: 'created_at', type: 'DATETIME', nullable: true });
            }
            else if (entity === 'product') {
                columns.push({ name: 'price', type: 'DECIMAL', nullable: true }, { name: 'category', type: 'TEXT', nullable: true });
            }
            else if (entity === 'order') {
                columns.push({ name: 'customer_id', type: 'INTEGER', nullable: false, isForeignKey: true }, { name: 'total', type: 'DECIMAL', nullable: true }, { name: 'order_date', type: 'DATE', nullable: true });
            }
            else if (entity === 'merchant' || entity === 'restaurant') {
                columns.push({ name: 'merchant_id', type: 'INTEGER', nullable: false }, { name: 'total', type: 'DECIMAL', nullable: true }, { name: 'order_date', type: 'DATE', nullable: true });
            }
